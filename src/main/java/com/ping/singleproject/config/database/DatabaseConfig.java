package com.ping.singleproject.config.database;
...
public class DatabaseConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        factoryBean.setTypeAliasesPackage("com.ping.singleproject");
    ...
    public DataSourceTransactionManager dataSourceTransactionManager() {
        return new DataSourceTransactionManager(this.logDataSource());
    }
